...
static const char auth_key_test[] = "ZvO0eBKleQVMLIK1SqZJhdwk7xUHtYfI";
static const char device_id_test[] = "tuya290051fdb1de";
static const uint8_t mac_test[6] = {0x0C,0xAA,0x3C,0x4D,0x23,0xDC}; //The actual MAC address is : DC234D3CAA0E
