...
This demo is based on the Tuya Smart Cloud Platform, Tuya Smart App, IoTOS Embeded Ble SDK, using Tuya BLE  series modules to quickly build a smart neck massager demo based on the TLSR8253 chip platform.
