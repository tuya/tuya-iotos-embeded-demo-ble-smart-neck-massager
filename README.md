# Tuya IoTOS Embedded Bluetooth LE Smart Neck Massager

[English](./README.md) | [中文](./README_zh.md)

## Overview

In this demo, we will show you how to retrofit an ordinary neck massager and make it IoT-enabled. Based on the [Tuya IoT Platform](https://iot.tuya.com/), we use Tuya's Bluetooth LE module, SDK, and the Tuya Smart app to connect the TLSR8253 chip-based neck massager to the cloud.
